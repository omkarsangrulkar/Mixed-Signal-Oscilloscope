 ...
 ***************************************************/
#define DISPL_PRESCALER SPI_BAUDRATEPRESCALER_8     //prescaler assigned to display SPI port
#define TOUCH_PRESCALER SPI_BAUDRATEPRESCALER_8	//prescaler assigned to touch device SPI port
